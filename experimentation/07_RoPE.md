...
Overall, RoPE clearly has insane potential and has improved this model significantly. I'm going to bring the n_embd back up to 384 and iterations down to 2000 for a final run to determine what the best parameters to use for future runs are. 
